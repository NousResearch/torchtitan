#!/bin/bash
#SBATCH --job-name=scmoe_time
#SBATCH --nodes=8
#SBATCH --exclusive
#SBATCH --partition=batch
#SBATCH --qos=low
#SBATCH --time=00:30:00
#SBATCH --output=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/deepep_scmoe_timing_%j.out
#SBATCH --error=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/deepep_scmoe_timing_%j.err
...
echo "ScMoE + DeepEP TIMING run: validating overlap"
