...
deepseekv3_configs = {
    ...
    "236B_flex_attn": DeepSeekV3ModelArgs(
        vocab_size=102400,
        dim=5120,
        inter_dim=12288,
        moe_inter_dim=1536,
    ...
    "236B_greedy": DeepSeekV3ModelArgs(
        vocab_size=102400,
        dim=5120,
        inter_dim=12288,
        moe_inter_dim=1536,
    ...
    "236B_kimi": DeepSeekV3ModelArgs(
        vocab_size=129280, # DSV3 tokenizer for now until fix kimi tokenizer
        dim=5120,
        inter_dim=12288,
        moe_inter_dim=1536,
        n_layers=60,
    ...
    "236B_kimi_flex_attn": DeepSeekV3ModelArgs(
        vocab_size=129280, # DSV3 tokenizer for now until fix kimi tokenizer
        dim=5120,
        inter_dim=12288,
        moe_inter_dim=1536,
    ...
    "671B_kimi_flex_attn": DeepSeekV3ModelArgs(
        vocab_size=129280,
        dim=7168,
        inter_dim=18432,
        moe_inter_dim=2048,
    ...
    "1T_kimi_flex_attn": DeepSeekV3ModelArgs(
        vocab_size=129280, # DSV3 tokenizer for now until fix kimi tokenizer
        dim=7168,
        inter_dim=18432,
        moe_inter_dim=2048,
