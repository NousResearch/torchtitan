...
def apply_fsdp(
    ...
    for layer_id, transformer_block in model.layers.items():
        ...
        if transformer_block.moe_enabled and ep_degree > 1:
            ...
            # FIX: reshard_after_forward=False to avoid all-gather buffer scaling with dp_mod_ep_mesh.size()
            # See: https://github.com/pytorch/pytorch/issues/147179
            fully_shard(
                transformer_block.moe.experts,
                **fsdp_mod_ep_config,
                reshard_after_forward=False,  # Changed from reshard_after_forward
