...
if has_torchft:
    import torchft as ft  # type: ignore[import]

# hardcoding for now. I don't know why this doesn't import normally in slurm but it does interactively?
DION_AVAILABLE = True
MUON_AVAILABLE = True
...
# except ImportError:
#     warnings.warn(
#         "Dion optimizer is not available. Dion optimizers will not be usable."
#     )
#     DION_AVAILABLE = False

# try:
#     from torchtitan.experiments.dion_optimizer.muon import Muon
#     from torchtitan.experiments.dion_optimizer.titan_muon import MuonOptimizersContainer

#     MUON_AVAILABLE = True
# except ImportError:
#     warnings.warn(
#         "Muon optimizer is not available. Muon optimizers will not be usable."
#     )
