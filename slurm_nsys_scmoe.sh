#!/bin/bash
#SBATCH --job-name=nsys_scmoe
#SBATCH --nodes=8
#SBATCH --exclusive
#SBATCH --partition=batch
#SBATCH --qos=low
#SBATCH --time=00:30:00
#SBATCH --output=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/nsys_scmoe_%j.out
#SBATCH --error=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/nsys_scmoe_%j.err
...
CONFIG_FILE="torchtitan/models/deepseek_v3/train_configs/seqlen_8k_cp1_lbs2_deepep_scmoe_profile.toml"
NSYS_DIR="${TORCHTITAN_DIR}/outputs/nsys_scmoe"
...
# nsys on first node
NSYS_CMD="nsys profile --trace=cuda,nvtx,osrt,cublas --cuda-graph-trace=node --sample=none --cpuctxsw=none --output=${NSYS_DIR}/scmoe_${SLURM_JOB_ID} --force-overwrite true --stats=true"
...
echo "nsys trace saved to: ${NSYS_DIR}/scmoe_${SLURM_JOB_ID}.nsys-rep"
