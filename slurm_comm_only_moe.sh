#!/bin/bash
#SBATCH --job-name=moe_prof
#SBATCH --nodes=8
#SBATCH --exclusive
#SBATCH --partition=batch
#SBATCH --qos=low
#SBATCH --time=00:30:00
#SBATCH --output=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/comm_only_%j.out
#SBATCH --error=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/comm_only_%j.err

# CommOnlyMoE experiment: router + DeepEP dispatch/combine, no GEMM, no shared expert.
# Set NOOP_ATTN=1 to also skip attention.

COMM_ONLY_MOE=${COMM_ONLY_MOE:-0}
EMPTY_MOE=${EMPTY_MOE:-0}
NOOP_ATTN=${NOOP_ATTN:-0}
NOOP_DEEPEP=${NOOP_DEEPEP:-0}
...
echo "COMM_ONLY_MOE=${COMM_ONLY_MOE}"
echo "EMPTY_MOE=${EMPTY_MOE}"
echo "NOOP_ATTN=${NOOP_ATTN}"
echo "NOOP_DEEPEP=${NOOP_DEEPEP}"
