#!/bin/bash
#SBATCH --job-name=prof_scmoe
#SBATCH --nodes=8
#SBATCH --exclusive
#SBATCH --partition=batch
#SBATCH --qos=low
#SBATCH --time=00:30:00
#SBATCH --output=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/prof_scmoe_%j.out
#SBATCH --error=/home/phuc/workspace/moe/moe_throughputs/slurm_logs/prof_scmoe_%j.err
...
PROFILE_DIR="${TORCHTITAN_DIR}/outputs/profile_scmoe/nsys"
...
echo "SCMOE profiling: LBS=2, seq=8k, EP=64, DeepEP + ScMoE overlap"
